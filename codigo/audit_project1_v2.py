...
def main() -> int:
    ...
    expected = [
        ".github/README.md",
        "codigo/proyecto1_v2_pipeline.py",
        "codigo/compare_versions.py",
        "codigo/postprocess_v2.py",
        "codigo/deliverables_v2.py",
        "codigo/crear_ficha_repositorio_v2.py",
        ...
        "entregables/cuaderno/Proyecto_1_Monitoreo_Transaccional_V2.ipynb",
        "entregables/informe/informe_proyecto1_v2.tex",
        "entregables/informe/informe_proyecto1_v2.pdf",
        "entregables/presentacion/presentacion_proyecto1_v2.html",
        "entregables/presentacion/presentacion_proyecto1_v2.pdf",
        "entregables/ficha/Ficha_Repositorio_Proyecto_1_V2.docx",
        "entregables/ficha/Ficha_Repositorio_Proyecto_1_V2.pdf",
    ]
    for rel in expected:
    ...
    notebook_path = (
        ROOT / "entregables/cuaderno/Proyecto_1_Monitoreo_Transaccional_V2.ipynb"
    )
    ...
    slides_path = ROOT / "entregables/presentacion/presentacion_proyecto1_v2.html"
    ...
    pdf = ROOT / "entregables/informe/informe_proyecto1_v2.pdf"
    if pdf.exists():
    ...
    slides_pdf = ROOT / "entregables/presentacion/presentacion_proyecto1_v2.pdf"
    if slides_pdf.exists():
        check(
            len(fitz.open(slides_pdf)) == 8,
            "El PDF de presentación no tiene ocho páginas",
        )
    ficha_pdf = ROOT / "entregables/ficha/Ficha_Repositorio_Proyecto_1_V2.pdf"
    if ficha_pdf.exists():
