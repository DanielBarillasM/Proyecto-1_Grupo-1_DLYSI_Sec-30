...
def main() -> None:
    ...
    notebook_path = ROOT / "entregables" / "cuaderno" / "proyecto1_calderon_barillas.ipynb"
    ...
    report_pdf = ROOT / "entregables" / "informe" / "informe.pdf"
    slides_pdf = ROOT / "entregables" / "presentacion" / "presentacion.pdf"
