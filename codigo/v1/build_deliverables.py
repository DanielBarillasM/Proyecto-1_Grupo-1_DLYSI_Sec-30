...
"""))
    ...
    ROOT/'artefactos'/'modelo_A_histgradientboosting.joblib',
    ROOT/'artefactos'/'modelo_B_gru.pt',
    ROOT/'artefactos'/'modelo_C_hibrido.pt',
    ROOT/'artefactos'/'preprocesamiento.joblib',
    ROOT/'artefactos'/'umbrales.json',
]
...
"""))
    cells.append(nbf.v4.new_code_cell("""errors = pd.read_csv(ROOT/'artefactos'/'patrones_error.csv').head(12)
