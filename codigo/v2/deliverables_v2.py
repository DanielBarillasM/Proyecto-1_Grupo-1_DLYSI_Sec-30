...
python -u codigo/v2/proyecto1_v2_pipeline.py
python codigo/v2/postprocess_v2.py
python codigo/v2/compare_versions.py
python codigo/v2/deliverables_v2.py
python codigo/v2/crear_ficha_repositorio_v2.py
python codigo/v2/audit_project1_v2.py
```
...
"""
    path = ROOT / "entregables/ficha/v2/README_V2.md"
...
**Declaración de IA.** Se utilizó asistencia para estructurar código, redacción, visualización y auditoría. Los autores ejecutaron el experimento, verificaron las cifras y asumen responsabilidad por interpretación, seguridad y defensa.""")
    ...
    out = ROOT / "entregables/cuaderno/v2/Proyecto_1_Monitoreo_Transaccional_V2.ipynb"
    nbf.write(nb, out)
...
def slides():
    ...
    (ROOT / "entregables/presentacion/v2/presentacion_proyecto1_v2.html").write_text(
...
\end{{document}}"""
    out = ROOT / "entregables/informe/v2/informe_proyecto1_v2.tex"
