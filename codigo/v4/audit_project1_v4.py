...
def main() -> int:
    ...
    required = [
        ".github/README.md",
        "codigo/v4/dataset_v4_support.py", "codigo/v4/proyecto1_v4_pipeline.py",
        "codigo/v4/postprocess_v4.py", "codigo/v4/build_v4_deliverables.py", "codigo/v4/audit_project1_v4.py",
        ...
        "entregables/cuaderno/v4/Proyecto_1_Monitoreo_Transaccional_V4.ipynb",
        "entregables/informe/v4/informe_proyecto1_v4.tex", "entregables/informe/v4/informe_proyecto1_v4.pdf",
        "entregables/presentacion/v4/presentacion_proyecto1_v4.html", "entregables/presentacion/v4/presentacion_proyecto1_v4.pdf",
        "entregables/ficha/v4/Ficha_Repositorio_Proyecto_1_V4.docx", "entregables/ficha/v4/Ficha_Repositorio_Proyecto_1_V4.pdf",
    ]
    ...
    notebook_path = ROOT / "entregables/cuaderno/v4/Proyecto_1_Monitoreo_Transaccional_V4.ipynb"
    ...
    report_pdf = ROOT / "entregables/informe/v4/informe_proyecto1_v4.pdf"
    if report_pdf.exists():
        pages = len(fitz.open(report_pdf))
        check(5 <= pages <= 7, f"Informe V4 tiene {pages} páginas; se esperan 5–7")
    presentation_pdf = ROOT / "entregables/presentacion/v4/presentacion_proyecto1_v4.pdf"
    if presentation_pdf.exists():
        check(len(fitz.open(presentation_pdf)) == 8, "Presentación PDF no tiene 8 páginas")
    presentation_html = ROOT / "entregables/presentacion/v4/presentacion_proyecto1_v4.html"
    ...
    ficha_pdf = ROOT / "entregables/ficha/v4/Ficha_Repositorio_Proyecto_1_V4.pdf"
    if ficha_pdf.exists():
