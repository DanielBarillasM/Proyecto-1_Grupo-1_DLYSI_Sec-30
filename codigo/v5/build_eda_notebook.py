...
DEFAULT_OUTPUT = ROOT / "entregables" / "cuaderno" / "v5" / "EDA_IEEE_CIS_Diagnostico_Datos.ipynb"
...
def build_notebook(output: Path = DEFAULT_OUTPUT) -> Path:
    ...
    <div class="eda-hero">
      ...
      <h2>Análisis causal, temporal y multivariado para explicar las limitaciones observadas en V5</h2>
      <div class="hero-grid">
    ...
    key_definitions={
        ...
        "Tarjeta ampliada + dirección (V5)":["card1","card2","card3","card5","addr1"],
        "V5 + correo":["card1","card2","card3","card5","addr1","P_emaildomain"],
    ...
    current=entity_diag.loc["Tarjeta ampliada + dirección (V5)"]
    display(HTML(f'<div class="callout stop"><b>Limitación estructural de B.</b> La clave V5 ofrece '
    ...
    notebook.metadata={"kernelspec":{"display_name":"Python 3","language":"python","name":"python3"},
                       ...
                       "project":{"name":"Proyecto 1 · Monitoreo transaccional",
                                  "stage":"EDA diagnóstico posterior a V5","seed":22193}}
